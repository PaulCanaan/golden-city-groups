...
If the public website and a later direct pastoral decision differ, record the updated decision in `decision-log.md` rather than silently changing the ministry's alignment.
