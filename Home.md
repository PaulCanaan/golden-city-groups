...
## How the Ministry Holds Together
...
[[Belonging, Beholding, Becoming]] · [[docs/ministry-model|Ministry Model]]
...
The documents are arranged to keep the ministry's deepest convictions close to its everyday work:

- Principles before procedures
- Theology before strategy
- Formation before programming
- Systems before resources
- People before processes

This guide preserves ministry wisdom rather than merely recording activity. Each document has one primary responsibility. When an idea is governed elsewhere, another document should name it briefly and lead the reader back to its source.

Those developing or revising these documents should also follow [[AGENTS]] and the governing context under `docs/`. Confirmed decisions, proposals, assumptions, and open questions should remain clearly distinguished.

## Where to Begin

Begin with [[Mission]], [[Vision]], and [[Values]] to understand the church's direction and the ministry's place within it.
