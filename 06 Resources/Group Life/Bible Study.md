# Scripture and Sermon Discussion

## Document Status

**Proposed leader resource aligned with the confirmed City Group model.** Exact sermon-discussion production, review, and distribution responsibilities remain pending.
...
2. Identify the central gospel or discipleship claim without adding an unapproved doctrinal position.
3. Pray for wisdom, humility, and the people in the group.
4. Choose a small number of open questions that move from understanding to response.
5. Anticipate unfamiliar terms, common misunderstandings, and any topic that should be referred to pastoral leadership.
...
- Ask one clear question at a time and allow silence.
- Invite multiple voices before supplying your own answer.
- Keep the discussion connected to the biblical text rather than speculation.
- Welcome honest questions without pretending every question has a simple answer.
- Say when you do not know, then use the approved pastoral or theological follow-up path.
- Redirect divisive, conspiratorial, partisan, or personally attacking discussion.
- Never use group discussion to pressure disclosure or provide unqualified counseling.

## Formation Relationship

- **Belonging:** Scripture is encountered in a patient, participatory community.
- **Beholding:** attention is directed toward Christ through God's Word.
- **Becoming:** hearing leads toward faithful response and shared obedience.
