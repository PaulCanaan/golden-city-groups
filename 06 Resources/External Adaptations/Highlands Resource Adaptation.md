# Church of the Highlands Resource Adaptation

## Document Status

**Completed source analysis; not a governing ministry decision.** This document records how the Church of the Highlands resources supplied on July 27, 2026 were evaluated for Golden City Church. It preserves attribution and prevents source material from being mistaken for GCC policy, theology, or approved operating structure.

## Purpose

Learn from a mature small-groups system without importing its scale, vocabulary, programs, leadership hierarchy, or assumptions into a pre-launch church plant.

## Source Set Reviewed

- *COTH24 Small Groups Leader Guide* PDF and InDesign production files
- *Small Group Coach's Guide* PDF and Word editions
- *Coaches Training Host Notes* and *Coaching - Director Resource*
- *Practical Coaching Tips*
- *Leader Conversation Card*
- *Leader Development Overview*
- *Next Steps Resource*
- *SGLT Checklist*
- *Small Groups Calendar and Reporting*
- *Small Groups FAQs*
- *Small Groups Monthly One Pager at a Glance*

The PDF exports were used as the readable authority for the InDesign companions. The PDF and Word editions of the coach guide contain substantially the same core material.

## Evaluation Standard

Each practice was evaluated against:
...
| Highlands' detailed leadership honor code. | **Do not import as policy.** | GCC needs its own pastorally approved leader covenant and correction process. |
| A background check as the primary requirement for groups involving minors. | **Do not treat as sufficient.** | GCC's complete safeguarding, supervision, reporting, and parent or guardian requirements remain pending. |
| Broad collections of topical Scripture references. | **Do not reproduce.** | GCC resources should arise from its theological framework, approved translations, and specific ministry use. |
...
These resources are original GCC adaptations and summaries. They do not reproduce the Highlands manuals, scripts, design, program names, or full Scripture collections. The supplied source files remain outside the repository and should not be redistributed from this project without appropriate permission.
