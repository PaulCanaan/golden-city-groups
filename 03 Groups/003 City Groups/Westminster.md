# Westminster City Group

## Document Status

**Planning scaffold — not confirmed active.** This page preserves Westminster as a possible City Group community. It does not establish that a group, leader, host, coach, location, meeting time, study, roster, or launch assignment exists.
...
- [[05 Leadership/Group Leaders]] — Records the selection and preparation process without naming unapproved leaders.
- [[05 Leadership/Hosts]] — Host requirements and appointments remain pending.
- [[05 Leadership/Group Coaches]] — A formal coaching layer is not confirmed for initial launch.
- [[Weekly Recaps]] — Applies only if this community becomes an approved active group and a secure recap process is established.
- [[07 Operations/Metrics]] — Evaluation remains provisional and must follow approved participant-data boundaries.
