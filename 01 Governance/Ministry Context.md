...
**Confirmed governing context.** This document records approved background and church alignment. It does not replace Golden City Church's official public statements or pastoral authority.
...
Team Nights on July 28, August 11, and August 25, 2026 were scheduled to include dedicated time for City Group vision, leader sign-ups, leader discernment, placement conversations, and preparation for the September launch. Paul was assigned as the on-site sign-up point person, responsible for helping interested Launch Team members submit the Planning Center form, receiving and organizing submissions through his admin access, and emailing applicants about Group Leader Conversations and immediate next steps. Actual event outcomes remain subject to reconciliation. A sign-up or conversation expresses interest and begins assessment; neither constitutes appointment or final group assignment.

## Church Alignment

Groups Ministry must remain aligned with Golden City Church's official mission, vision, theology, language, leadership, and overall growth orientation. It must not develop an independent identity that competes with the identity of the church.

Golden City Church's public language currently includes:

- **Vision:** To see the city fully following Jesus.
- **Mission:** To equip people to forge their faith, find freedom in Christ, and follow him fully.
- **Values:** Jesus as the church's pursuit; Scripture as its authority; the Holy Spirit as its power; people as its heart; service as its privilege; generosity as its lifestyle; and flourishing as its goal.

Authoritative public sources:

- [Golden City Church](https://www.goldencity.church/)
- [What We Believe](https://www.goldencity.church/beliefs)
- [Leadership](https://www.goldencity.church/leadership)

If the public website and a later direct pastoral decision differ, record the updated decision in `00 Dashboard/Decision Log.md` rather than silently changing the ministry's alignment.
...
This previously approved wording is preserved rather than rewritten. DEC-034 governs the current Groups Ministry architecture; its reference to Classes now describes future development under Bible Clubs, not a current fourth branch. The purpose remains a ministry-level expression of Golden City Church's identity, not a replacement for the church's mission or vision.

## Confirmed Ministry Architecture
...
Paul is a biblical studies student, curriculum designer, group leader, and ministry builder. His primary theological interests include:
...
Paul values formation over information alone. His ministry approach is pastoral, theological, relational, missional, and structurally thoughtful.

These interests may shape questions, curriculum, and ministry design, but they do not independently establish Golden City Church's official theological positions.

## Planning Posture

The ministry should support the church's launch without building structures too complicated to operate. Design work must distinguish:

- The **minimum viable launch model** needed to serve people faithfully in 2026
- The **ideal future model** that may develop as leaders, participants, and capacity grow

## Known Repository Context

The existing repository contains scaffolding for:

- The Belonging, Beholding, Becoming formation framework
- Men's and women's gatherings and breakout groups
- Geographic city groups
- Recurring and seasonal classes
...
The previously confirmed launch scope prioritizes City Groups, Men's Collective, Women's Collective, and Planted. Men's and Women's Collectives are confirmed expressions of the Collectives branch with first/third- and second/fourth-Wednesday rhythms respectively and an October 2026 readiness target; times, venue, leader appointments, participant paths, and final readiness remain unresolved. Run Club, Youth City Group, and Young Adults Group are deferred ideas rather than required launch offerings. Planted is confirmed as a twelve-week Bible Club beginning Tuesday evening, October 6, 2026, with Paul leading. Its curriculum is approved and is being finalized and published in Notion; location and final operating readiness remain unresolved.
