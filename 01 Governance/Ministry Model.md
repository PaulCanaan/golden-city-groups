...
The ministry purpose and three-branch architecture are **confirmed**. Specific offering assignments, schedules, locations, capacities, and remaining readiness details remain unconfirmed unless recorded in `00 Dashboard/Decision Log.md`.
...
This previously approved wording remains intact. Under DEC-034, its reference to Classes describes a future development path within the Bible Clubs branch rather than a current fourth branch.

## One Ministry, Three Branches

City Groups, Collectives, and Bible Clubs are not disconnected departments or interchangeable programs. They share:
...
- Scripture-centered conversation and faithful response
...
The approved long-term pathway is:

**Location-based City Groups → future home groups → activity-based groups → demographic-based groups → other approved expressions**
...
- All three branches lead toward prayer, service, mission, and helping form others.
...
4. A City Group provides community, prayer, care, and everyday discipleship; a Bible Club provides facilitated study of Scripture; a Collective provides gender-specific community and formation.
5. Future Classes may provide structured, teacher-led equipping when an offering is specifically approved.
...
Men's Collective and Women's Collective are confirmed expressions of the Collectives branch. No offering should be represented as active or launch-ready solely because a repository page exists.
...
- Which specific City Groups, Collectives, and Bible Clubs will complete launch readiness?
- What location, complete session calendar, capacity, support role, participant path, and final readiness approval will govern the first Planted Bible Club?
- How will people express interest and be placed?
- What role will membership play in group participation and leadership?
- What role-specific preparation, correction, removal, and authority details will implement the minimum leader, host, and instructor standard in DEC-027?
