...
**Proposed decisions for future staff meetings. Nothing in this brief is governing until staff or pastoral direction is recorded in the [[Decision Log|Active Decision Register]].**

## Confirmed Ministry Language

Golden City Groups has four approved ministry environments:

- **City Groups:** community where people live, using the Weekend Message Group Guide for relationship, prayer, and application.
- **Bible Clubs:** facilitator-led discussion through a book or section of the Bible at a designated gathering place.
- **Classes:** teacher-led, structured equipping around a topic in a classroom environment.
- **Collectives:** gender-specific ministry environments, currently expressed through Men's Collective and Women's Collective.

The prior percentage shorthand is superseded. Collectives are not a subtype of City Groups, Bible Clubs, or Classes. Each specific offering still requires ownership and launch-readiness review.

## Suggested Meeting Sequence

### Meeting 1 — Governance and Safety

Discuss PRO-025 through PRO-027. These decisions establish who may lead, how people are cared for, and which offerings may move toward launch.

### Meeting 2 — Launch Readiness and Systems

Discuss PRO-028 through PRO-030. These decisions complete Planted readiness, the leader-preparation sequence, and the participant intake system.

### Meeting 3 — Pastoral Formation

Discuss PRO-032 after the active offering set and participant paths are stable.
...
- [ ] Approve the recommended minimum standard
...
- [ ] Minimum care and safeguarding boundaries approved
...
- **Decision needed:** Approve the curriculum-review standard and confirm the remaining operating details for the first Planted course.
- **Confirmed context:** Paul is the instructor; the course will run nine or ten weeks leading to Christmas 2026.
- **Why it matters:** Instructor approval and a general course window do not by themselves authorize curriculum, location, enrollment, or launch.
...
- [ ] Pastoral and theological curriculum review completed
- [ ] Nine- or ten-week schedule and start date
- [ ] Location and facility owner
- [ ] Capacity and enrollment method
- [ ] Required materials and cost, if any
...
- [ ] Approve the recommended minimum baseline
