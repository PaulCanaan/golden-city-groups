...
This is the working dashboard for decisions that currently govern ministry development or require staff direction. It is intentionally concise.
...
- **Proposed** — prepared for staff consideration; not governing
- **Open operational item** — Paul may develop a recommendation, but a named detail is still needed
- **Archived** — full evidence and history are preserved in Decision History

## Current Governing Direction

| Decision | Governing direction | Status |
|---|---|---|
| DEC-001 | Golden City Church's public launch is September 20, 2026. | Confirmed |
| DEC-002–004 | Belonging, Beholding, Becoming guides formation; Groups and Classes form one ministry with an approved shared purpose. | Confirmed |
| DEC-005 | The repository's governing context and decision architecture direct substantive ministry development. | Confirmed |
| DEC-006–013 | Paul leads the ministry; City Groups, Collectives, and Planted form the planned complementary launch architecture and initial sign-up window. | Confirmed |
| DEC-014–016 | The July 23 public website and Church Center records are historical public-state baselines, not proof of current readiness or ownership. | Confirmed |
| DEC-017 | The Launch Team is the relational and ministry-development context from which the initial ministry teams are forming. | Confirmed |
| DEC-018–019 | Initial City Group leaders come from the Launch Team through Team Night interest, discernment, preparation, and explicit appointment. | Confirmed |
| DEC-020 | Planning Center Groups and Church Center are the operating platform; platform access or records do not confer ministry approval. | Confirmed |
...
### Recommended next staff meeting — governance and safety
...
### Following staff meeting — launch readiness and systems
...
| Proposal | Decision needed | Why now | Status |
|---|---|---|---|
| PRO-032 | [[Staff Decision Brief#PRO-032 — Pastoral Formation and Prayer Practices\|Pastoral Formation and Prayer Practices]] | Leaders need a shared baseline for freedom in Christ, flourishing, prayer, discernment, and ministry in the Holy Spirit. | Proposed; pastoral approval required |
...
6. Superseded or reviewed briefs move to the Archive; the active register remains short.
...
- **Status:** Confirmed
- **Date and approver:** Who approved it, and when?
