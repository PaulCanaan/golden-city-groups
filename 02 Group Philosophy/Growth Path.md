...
**Working recommendation; not an approved program sequence.** This page summarizes the relational participant journey already proposed in the Ministry Model. Membership, baptism, leadership, and public pathway details still require pastoral direction.

## Purpose

Help leaders offer a truthful next step without treating people as entries in an automatic ministry pipeline.
...
8. Mature disciples help form others with or without holding a formal title.

Movement is relational, prayerful, and non-linear. Participation in one environment is not a bureaucratic prerequisite for another.
...
Condensed from [[01 Governance/Ministry Model#Participant Journey|Ministry Model]], [[Discipleship]], [[Forms]], and [[00 Dashboard/Staff Decision Brief#PRO-030 — Church Center Intake and Planning Center Governance|PRO-030]].

## Connections

- [[Belonging, Beholding, Becoming]] — Formation framework.
- [[Healthy Groups]] — Environment health and readiness.
- [[Leadership Philosophy]] — Responsibility and appointment boundaries.
